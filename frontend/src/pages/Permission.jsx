      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-3xl w-full p-10">
        ...
        <div className="bg-[#bdf2d1] rounded-lg p-6 border border-[#bdf2d1]">
          ...
          <div>
            ...
            <div
              className={`rounded-lg mb-6 shadow-sm ${webcamPermission === "allowed" ? "bg-transparent p-0 border-none overflow-visible relative" : "bg-white p-4 border-2 border-dashed border-gray-300"}`}
            >
