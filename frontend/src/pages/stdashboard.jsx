...
<button
  onClick={() => {
    // Clear all viewing flags from localStorage
    localStorage.removeItem('adminViewingUserId');
    localStorage.removeItem('adminViewingUserName');
    localStorage.removeItem('adminViewingUserEmail');
    localStorage.removeItem('adminViewingUserRole');
    ...
    <div className="space-y-1">
      <div className="flex items-center justify-between text-xs">
        ...
        <span className="font-semibold text-gray-900">
          {dashboardData?.completedQuizzes ?? 22}/{dashboardData?.totalQuizzes ?? 24}
        </span>
      </div>
      <div className="w-full bg-gray-100 rounded-full h-2">
        <div
          ...
          style={{
            width: `${dashboardData && dashboardData.totalQuizzes && dashboardData.completedQuizzes
              ? (dashboardData.completedQuizzes / dashboardData.totalQuizzes) * 100
              : 92}%`,
          }}
        ></div>
      </div>
