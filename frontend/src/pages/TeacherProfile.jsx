...
const TeacherProfile = () => {
  ...
  const handleExportData = async () => {
    try {
      ...
      yPosition += 8;
      doc.text(
        `In-App Notifications: ${inAppNotifications ? "Enabled" : "Disabled"}`,
        20,
        yPosition
      );
      yPosition += 15;
      ...
      doc.text(
        `Emotion Detection Consent: ${
          emotionConsent ? "Granted" : "Not Granted"
        }`,
        20,
        yPosition
      );
      ...
      doc.text(
        "Account Created: " +
          (formData.createdAt || "Information not available"),
        20,
        yPosition
      );
      yPosition += 8;
      ...
      doc.text("Generated by Emexa Platform", pageWidth / 2, pageHeight - 10, {
        align: "center",
      });

      const fileName = `personal-data-${
