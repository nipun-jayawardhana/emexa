  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="relative h-64 pl-8 pr-4 pt-2 pb-12">
            ...
            <div className="absolute left-8 right-4 top-2 bottom-12 border-l border-b border-gray-400">
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                ...
                <polygon points="0,35 20,30 40,25 60,15 80,20 100,10 100,100 0,100" fill="#0d9488" opacity="0.1" />
                {/* Line path */}
                <polyline points="0,35 20,30 40,25 60,15 80,20 100,10" fill="none" stroke="#0d9488" strokeWidth="2" vectorEffect="non-scaling-stroke" />
              </svg>
              
              {/* Data points overlay */}
              <div className="absolute inset-0">
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "0%", top: "35%", transform: "translate(-50%, -50%)" }}></div>
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "20%", top: "30%", transform: "translate(-50%, -50%)" }}></div>
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "40%", top: "25%", transform: "translate(-50%, -50%)" }}></div>
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "60%", top: "15%", transform: "translate(-50%, -50%)" }}></div>
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "80%", top: "20%", transform: "translate(-50%, -50%)" }}></div>
                <div className="absolute w-2 h-2 bg-teal-700 rounded-full" style={{ left: "100%", top: "10%", transform: "translate(-50%, -50%)" }}></div>
              </div>
            </div>
        ...
        {/* Emotional State */}
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-[0_4px_8px_rgba(0,0,0,0.25)]">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Emotional State</h2>
          <div className="flex justify-center items-center h-64">
            <svg className="w-64 h-64" viewBox="0 0 200 200">
              {/* Happy - 40% (Dark Teal - Top Right) */}
              <path d="M 100,100 L 100,0 A 100,100 0 0,1 200,100 Z" fill="#0f766e" />
              {/* Confused - 30% (Light Green - Right) */}
              <path d="M 100,100 L 200,100 A 100,100 0 0,1 170.7,170.7 Z" fill="#86efac" />
              {/* Frustrated - 20% (Teal - Bottom) */}
              <path d="M 100,100 L 170.7,170.7 A 100,100 0 0,1 29.3,170.7 Z" fill="#14b8a6" />
              {/* Neutral - 10% (Yellow - Left) */}
              <path d="M 100,100 L 29.3,170.7 A 100,100 0 0,1 100,0 Z" fill="#fde047" />
            </svg>
          </div>
            ...
            <div key={index} className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-xs font-semibold text-gray-900">{student.engagement}</span>
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-green-500 h-2 rounded-full transition-all" style={{ width: `${student.progress}%` }}></div>
                </div>
              </div>
            </div>
          ))}
