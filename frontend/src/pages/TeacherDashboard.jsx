  ...
  if (isAdminViewing && adminToken) {
    return (
      <AdminViewWrapper dashboardType="teacher">
        <div className="bg-linear-to-br from-green-50 to-white min-h-screen">
          {renderContent()}
        </div>
      </AdminViewWrapper>
    );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {(showAllStudents ? students : students.slice(0, 4)).map(
              (student, index) => (
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-12 h-12 bg-linear-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center text-white text-xl shrink-0">
